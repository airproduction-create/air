            ...
            <RevealText delay={300}>
              <div className="space-y-6">
                {[
                  ...
                  { label: 'Based', value: 'London · Johannesburg · Remote' },
                ].map((item) => (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border border-border px-4 py-3 font-sans text-sm text-cream focus:outline-none focus:border-gold transition-colors duration-200"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-transparent border border-border px-4 py-3 font-sans text-sm text-cream focus:outline-none focus:border-gold transition-colors duration-200 resize-none"
